...
export const print_user_data = (userData) => {   
...
export const print_config_data = (configData) => {     
  console.log("===== Config Data =====") 

  console.table([
    { "Property": "total_lpusd", "Value" : configData.totalLpusd.toString()},
    { "Property": "total_percent", "Value": configData.totalPercent.toString()},
    { "Property": "epoch_duration", "Value" : configData.epochDuration.toString()},
    { "Property": "last_epoch_percent", "Value": configData.lastEpochPercent.toString()},
    { "Property": "last_epoch_profit", "Value" : configData.lastEpochProfit.toString()},
  ]);
}