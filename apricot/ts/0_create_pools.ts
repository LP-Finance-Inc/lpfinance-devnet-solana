...
const initialize_config = async () => {
    ...
    try {
        ...
        writePublicKey(configKeypair.publicKey, 'apricot_config')
        ...
        writePublicKey(stateAccount, 'apricot_pda')
        ...
        pubkeys += `export const RAY_Apricot_ATA = new PublicKey("${poolRay.toBase58()}")\n`;
        ...
        pubkeys += `export const WSOL_Apricot_ATA = new PublicKey("${poolWsol.toBase58()}")\n`;    
        ...
        pubkeys += `export const MSOL_Apricot_ATA = new PublicKey("${poolMsol.toBase58()}")\n`;
        ...
        pubkeys += `export const SRM_Apricot_ATA = new PublicKey("${poolSrm.toBase58()}")\n`;
        ...
        pubkeys += `export const SCNSOL_Apricot_ATA = new PublicKey("${poolScnsol.toBase58()}")\n`;
        ...
        pubkeys += `export const STSOL_Apricot_ATA = new PublicKey("${poolStsol.toBase58()}")\n`;

        writePublicKeys(pubkeys, "apricot_pools");
